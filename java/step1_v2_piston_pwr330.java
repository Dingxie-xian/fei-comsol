...
public class step1_v2_piston_pwr330 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Model model = ModelUtil.create("step1_v2_piston_pwr330");
        ...
        model.param().set("Z_down", "330[mm]");    // PML对照: 同 domain, PlaneWaveRadiation BC
        ...
        int idTop    = probeBoxFirst(comp, "p_top",    80.0,   145.0,  329.95,  330.05);  // top edge at z = Z_down = 330
